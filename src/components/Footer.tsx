...
const Footer = () => {
  return (
    <>
        <div className="px-4 container md:mx-auto flex flex-col md:flex-row justify-between pb-10 border-b border-gray-200">
            ...
            <div className="w-full md:w-8/12 flex justify-around pt-5 md:pt-0">
            ...
            <div className='px-4 flex justify-between py-5 container md:mx-auto'>
